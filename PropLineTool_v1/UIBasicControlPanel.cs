...
namespace PropLineTool.UI.ControlPanel
{
    ...
    public class UIBasicSingleParameterPanel : UIPanel
    {
        ...
        public static readonly Vector2 SIZE_MINI_CHECKBOX_LISTING = new Vector2(106f, 16f);
    ...
    public class UIBasicSpacingPanel : UIBasicSingleParameterPanel
    {
        ...
        public override void Awake()
        {
            ...
            //checkbox listing
            checkboxListingAutoDefault = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_MINI_CHECKBOX_LISTING, SIZE_MINI_CHECKBOX_BOX, Util.spriteUtilities.GetAtlas("PLTAtlas"));
    ...
    public class UIBasicAnglePanel : UIBasicSingleParameterPanel
    {
        ...
        public override void Awake()
        {
            ...
            //checkbox listings
            checkboxListingFlip180 = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_MINI_CHECKBOX_LISTING, SIZE_MINI_CHECKBOX_BOX, Util.spriteUtilities.GetAtlas("PLTAtlas"));
    ...
    public class UIBasicParametersPanel : UIPLTTabPanel
    {
        ...
        {
            if (PropLineTool.placementCalculator.AreLastContinueParametersZero() == true)
            {
        ...
        public override void Awake()
        {
            ...
            //buttons
            buttonDecoupleFromPreviousSegment = UISimpleElems.CreateBlueButton(this, "Decouple From Previous Segment", 0.875f, UIHorizontalAlignment.Center, UIVerticalAlignment.Middle, new RectOffset(6, 6, 2, 2), new Vector2(250f, 24f), new Vector3(62f, 25f));
            buttonDecoupleFromPreviousSegment.relativePosition = new Vector3(62f, 25f);
            buttonDecoupleFromPreviousSegment.Hide();

            //dividers
            //one
            dividerOne = UISimpleElems.CreateDivider(this, Util.spriteUtilities.GetAtlas("PLTAtlas"), "PLT_BasicDividerTile02x02", new Vector2(350f, 2f), new Vector3(12f, 115f));
            dividerOne.relativePosition = new Vector3(12f, 73f);
            //two
            dividerTwo = UISimpleElems.CreateDivider(this, Util.spriteUtilities.GetAtlas("PLTAtlas"), "PLT_BasicDividerTile02x02", new Vector2(350f, 2f), new Vector3(12f, 274f));
    ...
    public class UIBasicOptionsPanel : UIPLTTabPanel
    {
        ...
        public override void Awake()
        {
            ...
            //checkbox listings
            //show undo previews
            checkboxListingShowUndoPreviews = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_CHECK_LISTING_TIER_1, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            ...
            //error checking
            //  base
            checkboxListingErrorChecking = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_CHECK_LISTING_TIER_1, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            checkboxListingErrorChecking.label.text = "Error Checking: Enabled";
            ...
            //  error guides
            checkboxListingShowErrorGuides = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_CHECK_LISTING_TIER_2, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            ...
            //  anarchy PLT
            checkboxListingPLTAnarchy = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_CHECK_LISTING_TIER_2, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            checkboxListingPLTAnarchy.label.text = "PLT Anarchy : OFF";
            checkboxListingPLTAnarchy.tooltip = "If Enabled, items are placed regardless of collision-errors.";
            ...
            //  place blocked items
            checkboxListingPlaceBlockedItems = UISimpleElems.CreateCheckboxListing(this, 1, SIZE_CHECK_LISTING_TIER_3, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            ...
            //item rendering
            checkboxListingRenderPosResVanilla = UISimpleElems.CreateCheckboxListing(this, 2, SIZE_CHECK_LISTING_TIER_1, SIZE_CHECKBOX_24px, Util.spriteUtilities.GetAtlas("PLTAtlas"));
            checkboxListingRenderPosResVanilla.label.text = "Render and Place at Vanilla Resolution";
    ...
    public class UIBasicControlPanel : UIPanel
    {
        ...
        public override void Awake()
        {
            ...
            if ((_loadMode == ICities.LoadMode.LoadMap) || (_loadMode == ICities.LoadMode.LoadAsset) || (_loadMode == ICities.LoadMode.NewAsset) || (_loadMode == ICities.LoadMode.NewMap))
            {
                ...
                {
                    Debug.LogError("[PLT]: UIBasicControlPanel.Awake(): Could not find SnappingToggle atlas!");
                    _inGameAtlas = UIView.GetAView().defaultAtlas;
                }
                else
                {
                    SetAllSectionsVanillaAtlas(_inGameAtlas);
                    Debug.Log("[PLT]: UIBasicControlPanel.Awake(): Vanilla atlas set from snapping toggle.");
                }
            }
